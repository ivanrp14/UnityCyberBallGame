...
public class MeshDestroy : MonoBehaviour, IDestroyable
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            var fade = GameObject.AddComponent<FadeAndDestroy>();
            fade.fadeDuration = original.fadeDuration;
            fade.destroyOnStart = true;
